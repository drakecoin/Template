...
import { baySpotType, transformBayFeatures } from "../sources/socrataBays.js";
...
describe("transformBayFeatures", () => {
  const spots = transformBayFeatures(FIXTURE, [ZONE], { provenance: "Camden open data" });
